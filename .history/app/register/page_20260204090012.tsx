            ...
            >
                <div className="bg-white rounded-3xl shadow-2xl p-10 space-y-10 border border-purple-100/50">
                    ...
                    <div className="text-center space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 text-lg font-medium mt-3">
                                Entrez vos coordonnées pour commencer votre expérience
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="relative">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5 transition-colors group-focus-within:text-purple-500" />
                                        <input
                                            id="name"
                                            type="text"
                                            required
                            ...
                            <div className="space-y-3 md:col-span-2">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-gray-600 font-medium">8 caractères</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                        <span className="text-sm text-gray-600 font-medium">1 spécial</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-4 bg-purple-50/50 rounded-xl border border-purple-100">
                            <input
                                ...
                                id="terms"
                                required
                                className="mt-1 w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded focus:ring-3 focus:ring-purple-500/30"
                            />
                        ...
                        >
                            ...
                            {isLoading ? (
                                ...
                                <>
                                    <span className="relative z-10">Créer le compte</span>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-all duration-300 flex items-center justify-center gap-3 group">
                            <svg className="w-6 h-6 text-purple-600" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                            </svg>
                            <span className="font-bold text-gray-700 group-hover:text-purple-700">Facebook</span>
                        </button>
                        <button className="p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-pink-300 hover:bg-pink-50 transition-all duration-300 flex items-center justify-center gap-3 group">
                            ...
                            <span className="font-bold text-gray-700 group-hover:text-pink-700">Google</span>
                        </button>
                    </div>

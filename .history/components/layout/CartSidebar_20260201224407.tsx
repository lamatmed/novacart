                                            ...
                                            <div className="flex justify-between items-center mt-2">
                                                <div className="flex items-center gap-3 bg-gray-50 rounded-lg p-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`p-1 rounded-md shadow-sm transition-all ${item.quantity >= item.product.stock ? 'opacity-30 cursor-not-allowed text-gray-800' : 'hover:bg-white text-gray-700'}`}
                                                    >
